$.getJSON("http://vps227573.ovh.net/u-3.json",function(data){ //recupere les donnees ds le lien,les attribue à l'argument data//
 	...
 	// par ex : si attribut = "first_name" cela renverra à la valeur " karine "
